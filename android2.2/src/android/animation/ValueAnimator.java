...
/**
 * 本类提供一个时间引擎用于执行动画，该事件引擎用于计算动画值并将这些值应用到目标对象。有一个
 * 所有的动画都是用的时间脉冲，该脉冲运行在自定义的handler上来保证属性的修改执行在UI线程上。
 * <br>
...
public class ValueAnimator extends Animator {
	...
	/**
	 * 变量mPlayingState使用的值，用于表示当前动画的状态。
	 * <br>
	 ...
	 * during a call to
	 * {@link AnimatorUpdateListener#onAnimationUpdate(ValueAnimator)}, which is
	 * called during each animation frame, immediately after the value is
	 * calculated.
	 * 

 ...
 * <br/>所有package manager拥有的包子项拥有的公共信息。提供了一个公共的属性集合：icon，label，meta-data。
 * 本类需要被使用，他仅仅用来在package manager返回的子项之间共享数据定义。因此它自身并不实现parcelable,
 * 但是却提供了有效的方法来辅助子类实现parcelable接口
 */
public class PackageItemInfo {
    /**
     * Public name of this item. From the "android:name" attribute.
     * 该子项的名称，对应于android:name属性
     */
    public String name;
     ...
     * 该子项的label，对应于label属性，如果没有设置则为0
     */
    public int labelRes;
     ...
     * {@link PackageManager#GET_META_ DATA} flag when requesting the info.
     */
     ...
     * the application.
     * <br/>获取该子项的响应的label信息。如果label信息为空，则返回name，如果name为空则返回packgeName

 ...
 * manager of the application (accessible through getAssets()) and provides a
 * higher-level API for getting typed data from the assets. <br>
 * 访问应用程序资源的类，该类在应用程序asset manager顶层，并且提供了一个高级别的 对assets数据的访问
 */
public class Resources {
	 ...
	 *            selecting/computing resource values (optional).
	 * @param compInfo
	 *            this resource's compatibility info. It will use the default
	 *            compatibility info when it's null.
	 * @hide
	 */
	public Resources(AssetManager assets, DisplayMetrics metrics,
	 ...
	 * the current screen (can not use dimension units, does not change based on
	 * orientation, etc).
	 */
	...
	public CharSequence getQuantityText(int id, int quantity)
		...
		throw new NotFoundException("Plural resource ID #0x"
				+ Integer.toHexString(id)
				+ " quantity="
				+ quantity
				+ " item="
				+ PluralRules.stringForQuantity(rule
						.quantityForNumber(quantity)));
	}
	...
	/**
	 * Return the string value associated with a particular resource ID. It will
	 * be stripped of any styled text information. {@more}
	 * 
	 * @param id
	 *            The desired resource identifier, as generated by the aapt
	 *            tool. This integer encodes the package, type, and resource
	 ...
	 * {@link java.util.Formatter} and {@link java.lang.String#format}. It will
	 * be stripped of any styled text information. {@more}
	 * 
	 * @param id
	 *            The desired resource identifier, as generated by the aapt
	...
	/**
	 * Return the string value associated with a particular resource ID for a
	 * particular numerical quantity, substituting the format arguments as
	 * defined in {@link java.util.Formatter} and
	 * {@link java.lang.String#format}. It will be stripped of any styled text
	 * information. {@more}
	 * 
	 * @param id
	 *            The desired resource identifier, as generated by the aapt
	 ...
	 *         sure to call {@link TypedArray#recycle() TypedArray.recycle()}
	 *         when done with it.
	 */
	...
	/**
	 * Retrieve a dimensional for a particular resource ID. Unit conversions are
	 * based on the current {@link DisplayMetrics} associated with the
	 * resources.
	 * 
	 * @param id
	 *            The desired resource identifier, as generated by the aapt
	 ...
	 * in raw pixels. This is the same as {@link #getDimension}, except the
	 * returned value is converted to integer pixels for you. An offset
	 ...
	 *            entry. The value 0 is an invalid identifier.
	 * 
	 * @return Resource dimension value multiplied by the appropriate metric and
	...
	/**
	 * Retrieve a dimensional for a particular resource ID for use as a size in
	 * raw pixels. This is the same as {@link #getDimension}, except the
	 * returned value is converted to integer pixels for use as a size. A size
	 * conversion involves rounding the base value, and ensuring that a non-zero
	 * base value is at least one pixel in size.
	 * 
	 * @param id
	 *            The desired resource identifier, as generated by the aapt
	 *            tool. This integer encodes the package, type, and resource
	 ...
	 * @param pbase
	 *            The parent base value of this fraction. In other words, a
	 *            parent fraction (nn%p) is multiplied by this value.
	 * 
	 * @return Attribute fractional value multiplied by the appropriate base
	 *         value.
	 * 
	 * @throws NotFoundException
	 *             Throws NotFoundException if the given ID does not exist.
	 ...
	 * resource holds a complex {@link android.content.res.ColorStateList}, then
	 * the default color from the set is returned.
	 * 
	 * @param id
	 *            The desired resource identifier, as generated by the aapt
	 *            tool. This integer encodes the package, type, and resource
	 ...
	 * {@link android.content.res.ColorStateList} holding multiple possible
	 * colors.
	 * 
	 * @param id
	 ...
	 *             Throws NotFoundException if the given ID does not exist.
	 * 
	 * @return Returns a ColorStateList object containing either a single solid
	 ...
	 * functionality -- in particular, you can't change its input, and only the
	 * high-level events are available.
	 * 
	 * <p>
	 * This function is really a simple wrapper for calling {@link #getXml} with
	 * a layout resource.
	 * 
	 * @param id
	 *            The desired resource identifier, as generated by the aapt
	...
	/**
	 * Open a data stream for reading a raw resource. This can only be used with
	 * resources whose value is the name of an asset file -- that is, it can be
	 * used to open drawable, sound, and raw resources; it will fail on string
	 * and color resources.
	 * 
	 * @param id
	...
	public InputStream openRawResource(int id, TypedValue value)
		...
		try {
			return mAssets.openNonAsset(value.assetCookie,
					value.string.toString(), AssetManager.ACCESS_STREAMING);
		} catch (Exception e) {
	 ...
	 * with resources whose value is the name of an asset files -- that is, it
	 * can be used to open drawable, sound, and raw resources; it will fail on
	 ...
	 *            tool.
	 * 
	 * @return AssetFileDescriptor A new file descriptor you can use to read the
	 *         resource. This includes the file descriptor itself, as well as
	 *         the offset and length of data where the resource appears in the
	 *         file. A null is returned if the file exists but is compressed.
	 * 
	 * @throws NotFoundException
	 *             Throws NotFoundException if the given ID does not exist.
	 * 
	...
	public AssetFileDescriptor openRawResourceFd(int id)
		...
		synchronized (mTmpValue) {
			...
			try {
				return mAssets.openNonAssetFd(value.assetCookie,
						value.string.toString());
			} catch (Exception e) {
				NotFoundException rnf = new NotFoundException("File "
						+ value.string.toString()
	 ...
	 * @param resolveRefs
	 *            If true, a resource that is a reference to another resource
	 *            will be followed so that you receive the actual final resource
	 *            data. If false, the TypedValue will be filled in with the
	 *            reference itself.
	 * 
	 * @throws NotFoundException
	 *             Throws NotFoundException if the given ID does not exist.
	 ...
	 * getIdentifier() for information on how names are mapped to resource IDs,
	 * and getString(int) for information on how string resources are retrieved.
	 * 
	 * <p>
	...
	/**
	 * This class holds the current attribute values for a particular theme. In
	 * other words, a Theme is a set of values for resource attributes; these
	 * are used in conjunction with {@link TypedArray} to resolve the final
	 * value for an attribute.
	 * 
	 * <p>
	 * The Theme's attributes come into play in two ways: (1) a styled attribute
	 * can explicit reference a value in the theme through the "?themeAttribute"
	 * syntax; (2) if no value has been defined for a particular styled
	 * attribute, as a last resort we will try to find that attribute's value in
	 * the Theme.
	 * 
	 * <p>
	...
	public final class Theme {
		 ...
		 * argument: If false, only values that are not already defined in the
		 * theme will be copied from the system resource; otherwise, if any of
		 * the style's attributes are already defined in the theme, the current
		 * values in the theme will be overwritten.
		 * 
		 * @param resid
		 *            The resource ID of a style resource from which to obtain
		 *            attribute values.
		 * @param force
		 *            If true, values in the style resource will always be used
		 *            in the theme; otherwise, they will only be used if not
		 *            already defined in the theme.
		 */
		 ...
		 * <var>other</var>. If both of these themes are from the same Resources
		 * object, they will be identical after this function returns. If they
		 * are from different Resources, only the resources they have in common
		 * will be set in this theme.
		 * 
		 * @param other
		...
		public TypedArray obtainStyledAttributes(int[] attrs) {
			...
			TypedArray array = getCachedStyledAttributes(len);
			array.mRsrcs = attrs;
			AssetManager.applyStyle(mTheme, 0, 0, 0, attrs, array.mData,
					array.mIndices);
			return array;
		}
		...
		public TypedArray obtainStyledAttributes(int resid, int[] attrs)
			...
			AssetManager.applyStyle(mTheme, 0, resid, 0, attrs, array.mData,
					array.mIndices);
			if (false) {
		 ...
		 * <var>set</var> that are listed in <var>attrs</var>. In addition, if
		 * the given AttributeSet specifies a style class (through the "style"
		 * attribute), that style will be applied on top of the base attributes
		 * it defines.
		 * 
		 * <p>
		 * Be sure to call StyledAttributes.recycle() when you are done with the
		 ...
		 *            values for the StyledAttributes. Can be 0 to not look for
		 *            defaults.
		 * @param defStyleRes
		 *            A resource identifier of a style resource that supplies
		 *            default values for the StyledAttributes, used only if
		 *            defStyleAttr is 0 or can not be found in the theme. Can be
		 ...
		 * @param outValue
		 *            Filled in with the ultimate resource value supplied by the
		 *            attribute.
		 * @param resolveRefs
		 *            If true, resource references will be walked; if false,
		 *            <var>outValue</var> may be a TYPE_REFERENCE. In either
		 *            case, it will never be a TYPE_ATTRIBUTE.
		 * 
	 ...
	 * @return Returns a TypedArray holding an array of the attribute values. Be
	 *         sure to call {@link TypedArray#recycle() TypedArray.recycle()}
	 *         when done with it.
	 * 
	...
	public void updateConfiguration(Configuration config, DisplayMetrics metrics) {
		synchronized (mTmpValue) {
			...
			mAssets.setConfiguration(mConfiguration.mcc, mConfiguration.mnc,
					...
					mConfiguration.touchscreen, (int) (mMetrics.density * 160),
					mConfiguration.keyboard, keyboardHidden,
					mConfiguration.navigation, width, height,
					mConfiguration.screenLayout, mConfiguration.uiMode,
					sSdkVersion);
			int N = mDrawableCache.size();
			if (DEBUG_CONFIG) {
				Log.d(TAG,
						"Cleaning up drawables config changes: 0x"
								+ Integer.toHexString(configChanges));
			}
			for (int i = 0; i < N; i++) {
				WeakReference<Drawable.ConstantState> ref = mDrawableCache
						.valueAt(i);
				if (ref != null) {
					...
					if (cs != null) {
						if (Configuration.needNewResources(configChanges,
							...
							if (DEBUG_CONFIG) {
								Log.d(TAG,
										"FLUSHING #0x"
												+ Long.toHexString(mDrawableCache
														.keyAt(i))
												+ " / "
												+ cs
												+ " with changes: 0x"
	...
	/**
	 * Return the compatibility mode information for the application. The
	 * returned object should be treated as read-only.
	 * 
	 * @return compatibility info. null if the app does not require
	 *         compatibility mode.
	 * @hide
	 */
	 ...
	 * two components (package and type) are optional if defType and defPackage,
	 ...
	 * @param defPackage
	 *            Optional default package to find, if "package:" is not
	 *            included in the name. Can be null to require an explicit
	 *            package.
	 * 
	...
	/**
	 * Return the full name for a given resource identifier. This name is a
	 * single string of the form "package:type/entry".
	 * 
	 * @param resid
	...
	/**
	 * Parse a series of {@link android.R.styleable#Extra &lt;extra&gt;} tags
	 * from an XML file. You call this when you are at the parent tag of the
	 ...
	 * {@link android.R.styleable#Extra}. The following value types are
	 * supported:
	 * <ul>
	 * <li> {@link TypedValue#TYPE_STRING}: {@link Bundle#putCharSequence
	 * Bundle.putCharSequence()}
	 * <li> {@link TypedValue#TYPE_INT_BOOLEAN}: {@link Bundle#putCharSequence
	 * Bundle.putBoolean()}
	 * <li> {@link TypedValue#TYPE_FIRST_INT}-{@link TypedValue#TYPE_LAST_INT}:
	 * {@link Bundle#putCharSequence Bundle.putBoolean()}
	 * <li> {@link TypedValue#TYPE_FLOAT}: {@link Bundle#putCharSequence
	 * Bundle.putFloat()}
	 * </ul>
	 * 
	 * @param tagName
	 *            The name of the tag these attributes come from; this is only
	...
	public void parseBundleExtra(String tagName, AttributeSet attrs,
		...
		TypedValue v = sa
				.peekValue(com.android.internal.R.styleable.Extra_value);
		if (v != null) {
	...
	/**
	 * Start preloading of resource data using this Resources object. Only for
	 * use by the zygote process for loading common system resources. {@hide
	 * }
	 */
	...
	/**
	 * Called by zygote when it is done preloading resources, to change back to
	 * normal Resources operation.
	 */
			...
			if (dr == null) {
				...
				if (file.endsWith(".xml")) {
					try {
						...
						NotFoundException rnf = new NotFoundException("File "
								+ file + " from drawable resource ID #0x"
								+ Integer.toHexString(id));
						rnf.initCause(e);
						throw rnf;
					}
	...
	/* package */ColorStateList loadColorStateList(TypedValue value, int id)
		...
		if (value.string == null) {
			throw new NotFoundException(
					"Resource is not a ColorStateList (color or path): "
							+ value);
		}
		...
		if (file.endsWith(".xml")) {
			try {
				XmlResourceParser rp = loadXmlResourceParser(file, id,
						value.assetCookie, "colorstatelist");
				csl = ColorStateList.createFromXml(this, rp);
				rp.close();
			} catch (Exception e) {
				NotFoundException rnf = new NotFoundException("File " + file
						+ " from color state list resource ID #0x"
						+ Integer.toHexString(id));
				rnf.initCause(e);
				throw rnf;
			}
	...
	/* package */XmlResourceParser loadXmlResourceParser(String file, int id,
		...
		if (id != 0) {
			try {
				...
				synchronized (mCachedXmlBlockIds) {
					...
					XmlBlock block = mAssets.openXmlBlockAsset(assetCookie,
							file);
					if (block != null) {
				...
				NotFoundException rnf = new NotFoundException("File " + file
						+ " from xml type " + type + " resource ID #0x"
						+ Integer.toHexString(id));
				rnf.initCause(e);
				throw rnf;
			}
		...
		throw new NotFoundException("File " + file + " from xml type " + type
	...
	public Display getDefaultDisplay(Display defaultDisplay) {
		if (mDefaultDisplay == null) {
			if (!mCompatibilityInfo.isScalingRequired()
					&& mCompatibilityInfo.supportsScreen()) {

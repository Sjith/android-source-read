...
public interface ViewParent {
	 ...
	 * 
	 * @param location
	 *            An array of 2 ints containing the left and top coordinates of
	 *            the child to invalidate
	 * @param r
	 *            The area within the child that is invalid
	 * 
	 ...
	 * <li>the view port will be scrolled only just enough to make the rectangle
	 * visible</li>
	 * <ul>
	 * 
	 * @param child
	 ...
	 * @param rectangle
	 *            The rectangle in the child's coordinates the child wishes to
	 *            be on the screen.
	 * @param immediate

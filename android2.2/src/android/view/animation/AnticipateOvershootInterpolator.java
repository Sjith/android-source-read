...
/**
 * 动画从后面开始然后fling到前面并且超过目标值，最后回到目标值的插值器
 * <br>
...
public class AnticipateOvershootInterpolator implements Interpolator {
	 ...
	 *            there is no anticipation/overshoot and the interpolator
	 *            becomes a simple acceleration/deceleration interpolator.
	 */
	 ...
	 *            becomes a simple acceleration/deceleration interpolator.
	 * @param extraTension
	 *            Amount by which to multiply the tension. For instance, to get
	 *            the same overshoot as an OvershootInterpolator with a tension
	 *            of 2.0f, you would use an extraTension of 1.5f.
	 */
	...
	public float getInterpolation(float t) {
		...
		// f(t) = 0.5 * (o(t * 2 - 2, tension * extraTension) + 2), when t <=
		// 1.0
		if (t < 0.5f)

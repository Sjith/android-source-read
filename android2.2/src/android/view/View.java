 ...
 * drawing and event handling. View is the base class for <em>widgets</em>,
 * which are used to create interactive UI components (buttons, text fields,
 * etc.). The {@link android.view.ViewGroup} subclass is the base class for
 * <em>layouts</em>, which are invisible containers that hold other Views (or
 * other ViewGroups) and define their layout properties.
 * </p>
 * 
 * <div class="special">
 * <p>
 * For an introduction to using this class to develop your application's user
 * interface, read the Developer Guide documentation on <strong><a
 * href="{@docRoot}guide/topics/ui/index.html">User Interface</a></strong>.
 * Special topics include: <br/>
 * <a href="{@docRoot}guide/topics/ui/declaring-layout.html">Declaring
 * Layout</a> <br/>
 * <a href="{@docRoot}guide/topics/ui/menus.html">Creating Menus</a> <br/>
 * <a href="{@docRoot}guide/topics/ui/layout-objects.html">Common Layout
 * Objects</a> <br/>
 * <a href="{@docRoot}guide/topics/ui/binding.html">Binding to Data with
 * AdapterView</a> <br/>
 * <a href="{@docRoot}guide/topics/ui/ui-events.html">Handling UI Events</a> <br/>
 * <a href="{@docRoot}guide/topics/ui/themes.html">Applying Styles and
 * Themes</a> <br/>
 * <a href="{@docRoot}guide/topics/ui/custom-components.html">Building Custom
 * Components</a> <br/>
 * <a href="{@docRoot}guide/topics/ui/how-android-draws.html">How Android Draws
 * Views</a>.
 * </p>
 * </div>
 * 
 * <a name="Using"></a> <h3>Using Views</h3>
 * <p>
 ...
 * properties that are known at build time can be set in the XML layout files.</li>
 ...
 * <td>Constructors</td>
 * <td>There is a form of the constructor that are called when the view is
 * created from code and a form that is called when the view is inflated from a
 * layout file. The second form should parse and apply any attributes defined in
 * the layout file.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #onFinishInflate()}</code></td>
 * <td>Called after a view and all of its children has been inflated from XML.</td>
 * </tr>
 * 
 * <tr>
 * <td rowspan="3">Layout</td>
 * <td><code>{@link #onMeasure}</code></td>
 * <td>Called to determine the size requirements for this view and all of its
 * children.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #onLayout}</code></td>
 * <td>Called when this view should assign a size and position to all of its
 * children.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #onSizeChanged}</code></td>
 * <td>Called when the size of this view has changed.</td>
 * </tr>
 * 
 * <tr>
 * <td>Drawing</td>
 * <td><code>{@link #onDraw}</code></td>
 * <td>Called when the view should render its content.</td>
 * </tr>
 * 
 * <tr>
 * <td rowspan="4">Event processing</td>
 * <td><code>{@link #onKeyDown}</code></td>
 * <td>Called when a new key event occurs.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #onKeyUp}</code></td>
 * <td>Called when a key up event occurs.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #onTrackballEvent}</code></td>
 * <td>Called when a trackball motion event occurs.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #onTouchEvent}</code></td>
 * <td>Called when a touch screen motion event occurs.</td>
 * </tr>
 * 
 * <tr>
 * <td rowspan="2">Focus</td>
 * <td><code>{@link #onFocusChanged}</code></td>
 * <td>Called when the view gains or loses focus.</td>
 * </tr>
 * 
 * <tr>
 * <td><code>{@link #onWindowFocusChanged}</code></td>
 * <td>Called when the window containing the view gains or loses focus.</td>
 * </tr>
 * 
 * <tr>
 * <td rowspan="3">Attaching</td>
 * <td><code>{@link #onAttachedToWindow()}</code></td>
 * <td>Called when the view is attached to a window.</td>
 * </tr>
 * 
 * <tr>
 * <td><code>{@link #onDetachedFromWindow}</code></td>
 * <td>Called when the view is detached from its window.</td>
 * </tr>
 * 
 * <tr>
 * <td><code>{@link #onWindowVisibilityChanged}</code></td>
 * <td>Called when the visibility of the window containing the view has changed.
 * </td>
 * </tr>
 * </tbody>
 * 
 ...
 * </p>
 * 
 * <a name="IDs"></a> <h3>IDs</h3> Views may have an integer id associated with
 * them. These ids are typically assigned in the layout XML files, and are used
 * to find specific views within the view tree. A common pattern is to:
 * <ul>
 ...
 * </p>
 * 
 * <a name="Position"></a> <h3>Position</h3>
 * <p>
 * The geometry of a view is that of a rectangle. A view has a location,
 * expressed as a pair of <em>left</em> and <em>top</em> coordinates, and two
 * dimensions, expressed as a width and a height. The unit for location and
 ...
 * computations, namely {@link #getRight()} and {@link #getBottom()}. These
 * methods return the coordinates of the right and bottom edges of the rectangle
 * representing the view. For instance, calling {@link #getRight()} is similar
 * to the following computation: <code>getLeft() + getWidth()</code> (see <a
 * href="#SizePaddingMargins">Size</a> for more information about the width.)
 * </p>
 * 
 * <a name="SizePaddingMargins"></a> <h3>Size, padding and margins</h3>
 * <p>
 ...
 * <li>EXACTLY: This is used by the parent to impose an exact size on the child.
 * The child must use this size, and guarantee that all of its descendants will
 ...
 * </p>
 * 
 * <a name="Drawing"></a> <h3>Drawing</h3>
 * <p>
 ...
 * siblings drawn in the order they appear in the tree. If you set a background
 * drawable for a View, then the View will draw it for you before calling back
 * to its <code>onDraw()</code> method.
 * </p>
 * 
 * <p>
 * Note that the framework will not draw views that are not in the invalid
 * region.
 * </p>
 * 
 * <p>
 ...
 * </p>
 * 
 * <a name="EventHandlingThreading"></a> <h3>Event Handling and Threading</h3>
 * <p>
 * The basic cycle of a view is as follows:
 * <ol>
 * <li>An event comes in and is dispatched to the appropriate view. The view
 * handles the event and notifies any listeners.</li>
 * <li>If in the course of processing the event, the view's bounds may need to
 * be changed, the view will call {@link #requestLayout()}.</li>
 ...
 * 
 * <p>
 * <em>Note: The entire view tree is single threaded. You must always be on
 * the UI thread when calling any method on any view.</em> If you are doing work
 * on other threads and want to update the state of a view from that thread, you
 * should use a {@link Handler}.
 * </p>
 * 
 * <a name="FocusHandling"></a> <h3>Focus Handling</h3>
 * <p>
 * The framework will handle routine focus movement in response to user input.
 * This includes changing the focus as views are removed or hidden, or as new
 * views become available. Views indicate their willingness to take focus
 * through the {@link #isFocusable} method. To change whether a view can take
 * focus, call {@link #setFocusable(boolean)}. When in touch mode (see notes
 * below) views indicate whether they still would like focus via
 * {@link #isFocusableInTouchMode} and can change this via
 * {@link #setFocusableInTouchMode(boolean)}.
 * </p>
 * <p>
 ...
 * </p>
 * 
 * <a name="TouchMode"></a> <h3>Touch Mode</h3>
 * <p>
 * When a user is navigating a user interface via directional keys such as a
 * D-pad, it is necessary to give focus to actionable items such as buttons so
 * the user can see what will take input. If the device has touch capabilities,
 * however, and the user begins interacting with the interface by touching it,
 * it is no longer necessary to always highlight, or give focus to, a particular
 ...
 * {@link #isFocusableInTouchMode} is true will be focusable, such as text
 * editing widgets. Other views that are touchable, like buttons, will not take
 * focus when touched; they will only fire the on click listeners.
 * </p>
 * <p>
 ...
 * </p>
 * 
 * <a name="Scrolling"></a> <h3>Scrolling</h3>
 * <p>
 * The framework provides basic support for views that wish to internally scroll
 * their content. This includes keeping track of the X and Y scroll offset as
 * well as mechanisms for drawing scrollbars. See {@link #scrollBy(int, int)},
 * {@link #scrollTo(int, int)}, and {@link #awakenScrollBars()} for more
 * details.
 * </p>
 * 
 ...
 * </p>
 * 
 * <a name="Animation"></a> <h3>Animation</h3>
 * <p>
 * You can attach an {@link Animation} object to a view using
 * {@link #setAnimation(Animation)} or {@link #startAnimation(Animation)}. The
 * animation can alter the scale, rotation, translation and alpha of a view over
 * time. If the animation is attached to a view that has children, the animation
 * will affect the entire subtree rooted by that node. When an animation is
 * started, the framework will take care of redrawing the appropriate views
...
public class View implements Drawable.Callback, KeyEvent.Callback,
	 ...
	 * optimizations will be performed. It is okay to have this flag set and a
	 * background. Use with DRAW_MASK when calling setFlags. {@hide}
	 */
	static final int WILL_NOT_DRAW = 0x00000080;

	/**
	 * Mask for use with setFlags indicating bits used for indicating whether
	 * this view is will draw {@hide}
	 */
	...
	/**
	 * <p>
	 * Indicates this view can be clicked. When clickable, a View reacts to
	...
	private static final int[] DRAWING_CACHE_QUALITY_FLAGS = {
			DRAWING_CACHE_QUALITY_AUTO, DRAWING_CACHE_QUALITY_LOW,
			DRAWING_CACHE_QUALITY_HIGH };

	/**
	 * <p>
	 * Mask for use with setFlags indicating bits used for the cache quality
	 * property.
	 * </p> {@hide}
	 */
	...
	/**
	 * Mask to check if the scrollbar style is overlay or inset. {@hide}
	 */
	static final int SCROLLBARS_INSET_MASK = 0x01000000;

	/**
	 * Mask to check if the scrollbar style is inside or outside. {@hide}
	 */
	static final int SCROLLBARS_OUTSIDE_MASK = 0x02000000;

	/**
	 * Mask for scrollbar style. {@hide}
	 */
	static final int SCROLLBARS_STYLE_MASK = 0x03000000;

	/**
	 * View flag indicating that the screen should remain on while the window
	 * containing this view is visible to the user. This effectively takes care
	 * of automatically setting the WindowManager's
	 ...
	 * should add all focusable Views regardless if they are focusable in touch
	 * mode.
	 */
	...
	/**
	 * Use with {@link #focusSearch}. Move focus to the next selectable item.
	 */
	...
	/**
	 * Indicates the view is enabled, focused, selected and its window has the
	 * focus.
	 * 
	 * @see #ENABLED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	...
	/**
	 * Indicates the view is pressed, focused, selected and its window has the
	 * focus.
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 ...
	 */
	private static final int[][] VIEW_STATE_SETS = { EMPTY_STATE_SET, // 0 0 0 0
																		// 0
			...
			PRESSED_ENABLED_FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET, // 1 1 1
																		// 1 1
	};

	/**
	 * Used by views that contain lists of items. This state indicates that the
	 * view is showing the last item.
	 * 
	 * @hide
	 */
	...
	/**
	 * Used by views that contain lists of items. This state indicates that the
	 * view is showing the first item.
	 * 
	 * @hide
	 */
	...
	/**
	 * Used by views that contain lists of items. This state indicates that the
	 * view is showing the middle item.
	 * 
	 * @hide
	 */
	...
	/**
	 * Used by views that contain lists of items. This state indicates that the
	 * view is pressed and showing the last item.
	 * 
	 * @hide
	 */
	...
	/**
	 * Used by views that contain lists of items. This state indicates that the
	 * view is pressed and showing the first item.
	 * 
	 * @hide
	 */
	...
	/**
	 * Used by views that contain lists of items. This state indicates that the
	 * view is pressed and showing the middle item.
	 * 
	 * @hide
	 */
	...
	/**
	 * Used by views that contain lists of items. This state indicates that the
	 * view is pressed and showing only one item.
	 * 
	 * @hide
	 */
	 ...
	 * be extended in the future to hold our own class with more than just a
	 * Rect. :)
	 */
	...
	/**
	 * Width as measured during measure pass. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mMeasuredWidth;

	/**
	 * Height as measured during measure pass. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mMeasuredHeight;

	/**
	 * The view's identifier. {@hide}
	 * 
	 * @see #setId(int)
	 * @see #getId()
	 */
	 ...
	 * children and should therefore not cancel invalidate requests, even if
	 * they lie outside of this view's bounds.
	 * 
	 * {@hide}
	 */
	...
	/**
	 * Flag used to indicate that this view should be drawn once more (and only
	 * once more) after its animation has completed. {@hide}
	 */
	...
	/**
	 * Indicates that the View returned true when onSetAlpha() was called and
	 * that the alpha must be restored. {@hide}
	 */
	...
	/**
	 * View flag indicating whether this view was invalidated (fully or
	 * partially.)
	 * 
	 * @hide
	 */
	...
	/**
	 * Indicates a prepressed state; the short time between ACTION_DOWN and
	 * recognizing a 'real' press. Prepressed is used to recognize quick taps
	...
	@ViewDebug.ExportedProperty(flagMapping = {
			@ViewDebug.FlagToString(mask = FORCE_LAYOUT, equals = FORCE_LAYOUT, name = "FORCE_LAYOUT"),
			@ViewDebug.FlagToString(mask = LAYOUT_REQUIRED, equals = LAYOUT_REQUIRED, name = "LAYOUT_REQUIRED"),
			@ViewDebug.FlagToString(mask = DRAWING_CACHE_VALID, equals = DRAWING_CACHE_VALID, name = "DRAWING_CACHE_INVALID", outputIf = false),
	...
	/**
	 * The view flags hold various views states. {@hide}
	 */
	@ViewDebug.ExportedProperty
	int mViewFlags;

	/**
	 * The distance in pixels from the left edge of this view's parent to the
	 * left edge of this view. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mLeft;
	/**
	 * The distance in pixels from the left edge of this view's parent to the
	 * right edge of this view. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mRight;
	/**
	 * The distance in pixels from the top edge of this view's parent to the top
	 * edge of this view. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mTop;
	/**
	 * The distance in pixels from the top edge of this view's parent to the
	 * bottom edge of this view. {@hide}
	 */
	@ViewDebug.ExportedProperty
	 ...
	 * left edge of this view and the left edge of its content. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mPaddingLeft;
	/**
	 * The right padding in pixels, that is the distance in pixels between the
	 * right edge of this view and the right edge of its content. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mPaddingRight;
	/**
	 * The top padding in pixels, that is the distance in pixels between the top
	 * edge of this view and the top edge of its content. {@hide}
	 */
	@ViewDebug.ExportedProperty
	protected int mPaddingTop;
	/**
	 * The bottom padding in pixels, that is the distance in pixels between the
	 * bottom edge of this view and the bottom edge of its content. {@hide
	 * 
	 * }
	 */
	@ViewDebug.ExportedProperty
	...
	/**
	 * Briefly describes the view and is primarily used for accessibility
	 * support.
	 */
	...
	/**
	 * Cache the paddingBottom set by the user to append to the scrollbar's
	 * size.
	 */
	@ViewDebug.ExportedProperty
	...
	/**
	 * Listener used to build the context menu. This field should be made
	 * private, so it is hidden from the SDK. {@hide}
	 */
	...
	/**
	 * When this view has focus and the next focus is {@link #FOCUS_LEFT}, the
	 * user may specify which view to go to next.
	 */
	private int mNextFocusLeftId = View.NO_ID;

	/**
	 * When this view has focus and the next focus is {@link #FOCUS_RIGHT}, the
	 * user may specify which view to go to next.
	 */
	private int mNextFocusRightId = View.NO_ID;

	/**
	 * When this view has focus and the next focus is {@link #FOCUS_UP}, the
	 * user may specify which view to go to next.
	 */
	private int mNextFocusUpId = View.NO_ID;

	/**
	 * When this view has focus and the next focus is {@link #FOCUS_DOWN}, the
	 * user may specify which view to go to next.
	 */
	...
	/**
	 * Whether the long press's action has been invoked. The tap's action is
	 * invoked on the up event while a long press is invoked as soon as the long
	 * press duration is reached, so a long press could be performed before the
	 * tap is checked, in which case the tap's action should not be invoked.
	 */
	private boolean mHasPerformedLongPress;

	/**
	 * The minimum height of the view. We'll try our best to have the height of
	 * this view to at least this amount.
	 */
	@ViewDebug.ExportedProperty
	private int mMinHeight;

	/**
	 * The minimum width of the view. We'll try our best to have the width of
	 * this view to at least this amount.
	 */
	@ViewDebug.ExportedProperty
	 ...
	 * should be handled by another view.
	 */
	private TouchDelegate mTouchDelegate = null;

	/**
	 * Solid color to use as a background when creating the drawing cache.
	 ...
	 * view is available. Will not change whether the fading edge is enabled;
	 * use {@link #setVerticalFadingEdgeEnabled} or
	 * {@link #setHorizontalFadingEdgeEnabled} to enable the fading edge for the
	 * vertical or horizontal fading edges.
	 * 
	 * @param length
	 ...
	 * 
	 * @return The height in pixels of the horizontal scrollbar or 0 if there is
	...
	protected void initializeScrollbars(TypedArray a) {
		...
		final boolean fadeScrollbars = a.getBoolean(
				R.styleable.View_fadeScrollbars, true);
		...
		Drawable track = a
				.getDrawable(R.styleable.View_scrollbarTrackHorizontal);
		scrollabilityCache.scrollBar.setHorizontalTrackDrawable(track);

		Drawable thumb = a
				.getDrawable(R.styleable.View_scrollbarThumbHorizontal);
		if (thumb != null) {
			scrollabilityCache.scrollBar.setHorizontalThumbDrawable(thumb);
		}

		boolean alwaysDraw = a.getBoolean(
				R.styleable.View_scrollbarAlwaysDrawHorizontalTrack, false);
		if (alwaysDraw) {
		...
		alwaysDraw = a.getBoolean(
				R.styleable.View_scrollbarAlwaysDrawVerticalTrack, false);
		if (alwaysDraw) {
	...
	private void initScrollCache() {
		if (mScrollCache == null) {
			mScrollCache = new ScrollabilityCache(
					ViewConfiguration.get(mContext), this);
		}
	}
	 ...
	 * being built. If this view is not long clickable, it becomes long
	 * clickable.
	 * 
	 * @param l
	 *            The callback that will run
	 ...
	 * 
	 * @return True there was an assigned OnLongClickListener that was called,
	...
	/**
	 * Give this view focus. This will cause {@link #onFocusChanged} to be
	 * called.
	 * 
	 * Note: this does not check whether this {@link View} should get focus, it
	 * just gives it focus no matter what. It should only be called internally
	 * by framework code that knows what it is doing, namely
	 * {@link #requestFocus(int, Rect)}.
	 * 
	 * @param direction
	 *            values are View.FOCUS_UP, View.FOCUS_DOWN, View.FOCUS_LEFT or
	 *            View.FOCUS_RIGHT. This is the direction which focus moved when
	 *            requestFocus() is called. It may not always apply, in which
	 *            case use the default View.FOCUS_DOWN.
	 * @param previouslyFocusedRect
	 *            The rectangle of the view that had focus prior in this View's
	 *            coordinate system.
	 */
	 ...
	 * content is interesting. For example, a text editing view should call this
	 * when its cursor moves.
	 * 
	 * @param rectangle
	 *            The rectangle.
	...
	/**
	 * Called to clear the focus of a view that is about to be removed. Doesn't
	 * call clearChildFocus, which prevents this view from taking focus again
	 * before it has been removed from the parent
	 */
	 ...
	 * for which {@link #hasFocusable()} returns true. A
	 * "reachable hasFocusable()" is a View whose parents do not block
	 * descendants focus.
	 * 
	...
	/**
	 * Called by the view system when the focus state of this view changes. When
	 * the focus change event is caused by directional navigation, direction and
	 * previouslyFocusedRect provide insight into where the focus is coming
	 * from. When overriding, be sure to call up through to the super class so
	 * that the standard focus handling will occur.
	 * 
	 * @param gainFocus
	 *            True if the View has focus; false otherwise.
	 * @param direction
	 *            The direction focus has moved when requestFocus() is called to
	 *            give this view focus. Values are {@link #FOCUS_UP},
	 *            {@link #FOCUS_DOWN}, {@link #FOCUS_LEFT} or
	 *            {@link #FOCUS_RIGHT}. It may not always apply, in which case
	 *            use the default.
	 * @param previouslyFocusedRect
	 ...
	 *            from (in addition to direction). Will be <code>null</code>
	 *            otherwise.
	 */
	...
	/**
	 * Dispatches an {@link AccessibilityEvent} to the {@link View} children to
	 * be populated.
	 * 
	 * @param event
	 *            The event.
	...
	/**
	 * Invoked whenever this view loses focus, either by losing window focus or
	 * by losing focus within its window. This method can be used to clear any
	 * state tied to the focus. For instance, if a button is held pressed with
	 * the trackball and the window loses focus, this method can be used to
	 * cancel the press.
	 * 
	 ...
	 * its window. This will be used to determine whether the window can resize
	 * or must pan when a soft input area is open -- scrollable containers allow
	 * the window to use resize mode since the container will appropriately
	 * shrink.
	 */
	 ...
	 *         {@link #DRAWING_CACHE_QUALITY_LOW}, or
	 *         {@link #DRAWING_CACHE_QUALITY_HIGH}
	 * 
	...
	/**
	 * Set the drawing cache quality of this view. This value is used only when
	 * the drawing cache is enabled
	 * 
	 * @param quality
	 *            One of {@link #DRAWING_CACHE_QUALITY_AUTO},
	 *            {@link #DRAWING_CACHE_QUALITY_LOW}, or
	 *            {@link #DRAWING_CACHE_QUALITY_HIGH}
	 * 
	 ...
	 * 
	 * @param keepScreenOn
	 *            Supply true to set {@link #KEEP_SCREEN_ON}.
	 * 
	 * @see #getKeepScreenOn()
	 * 
	 * @attr ref android.R.styleable#View_keepScreenOn
	...
	public void setEnabled(boolean enabled) {
		...
		/*
		 * The View most likely has to change its appearance, so refresh the
		 * drawable state.
		 */
		refreshDrawableState();
	 ...
	 * 
	 * Setting this to false will also ensure that this view is not focusable in
	 * touch mode.
	 * 
	 * @param focusable
	...
	public void setFocusableInTouchMode(boolean focusableInTouchMode) {
		// Focusable in touch mode should always be set before the focusable
		// flag
		// otherwise, setting the focusable flag will trigger a
		// focusableViewAvailable()
		// which, in touch mode, will not successfully request focus on this
		// view
	 ...
	 * 
	 * <p>
	 * You may wish to disable haptic feedback if your view already controls its
	 * own haptic feedback.
	 * 
	 * @param hapticFeedbackEnabled
	 *            whether haptic feedback enabled for this view.
	 ...
	 * could be set on some View subclasses such as ViewGroup.
	 * 
	 ...
	 * offscreen bitmap. Some views, like an ImageView, must be able to bypass
	 * this mechanism if they already draw a single bitmap, to avoid unnecessary
	 * usage of the memory.
	 * 
	 ...
	 * {@link #setPressed(boolean)} is explicitly called, only clickable views
	 * can enter the pressed state.
	 * 
	 * @see #setPressed
	 * @see #isClickable()
	 * @see #setClickable(boolean)
	 ...
	 * {@link #onSaveInstanceState} method will be called).
	 * 
	 ...
	 * whether its {@link #onSaveInstanceState} method will be called). Note
	 * that even if freezing is enabled, the view still must have an id assigned
	 * to it (via {@link #setId setId()}) for its state to be saved. This flag
	 * can only disable the saving of this view; any child views may still have
	 * their state saved.
	 * 
	 * @param enabled
	 *            Set to false to <em>disable</em> state saving, or true (the
	 *            default) to allow it.
	 * 
	 * @see #isSaveEnabled()
	 * @see #setId(int)
	 ...
	 * mode. For example, a button would like focus when the user is navigating
	 * via a D-pad so that the user can click on it, but once the user starts
	 * touching the screen, the button shouldn't take focus
	 * 
	 ...
	 * use the root to look up the view. Once a view is found, it is cached for
	 * future lookups.
	 * 
	 * @param root
	 ...
	 * including this view if it is focusable itself) to views. If we are in
	 * touch mode, only add views that are also focusable in touch mode.
	 * 
	 * @param views
	 ...
	 * including this view if it is focusable itself) to views. This method adds
	 * all focusable views regardless if we are in touch mode or only views
	 * focusable in touch mode if we are in touch mode depending on the
	 * focusable mode paramater.
	 * 
	 * @param views
	 ...
	 * {@link #isFocusable} returns false), or if it is focusable and it is not
	 * focusable in touch mode ({@link #isFocusableInTouchMode}) while the
	 ...
	 * arguments {@link #FOCUS_DOWN} and <code>null</code>.
	 * 
	 ...
	 * rectangle that the focus is coming from. The rectangle can help give
	 * larger views a finer grained hint about where focus is coming from, and
	 * therefore, where to show selection, or forward focus change internally.
	 * 
	 * A view will not actually take focus if it is not focusable (
	 * {@link #isFocusable} returns false), or if it is focusable and it is not
	 * focusable in touch mode ({@link #isFocusableInTouchMode}) while the
	 ...
	 * have focus, and you want your parent to look for the next one.
	 * 
	 * You may wish to override this method if your custom {@link View} has an
	 * internal {@link View} that it wishes to forward the request to.
	 * 
	 * @param direction
	 *            One of FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, and FOCUS_RIGHT
	 * @param previouslyFocusedRect
	...
	/**
	 * Call this to try to give focus to a specific view or to one of its
	 * descendants. This is a special variant of {@link #requestFocus() } that
	 * will allow views that are not focuable in touch mode to request focus
	 ...
	 * with {@link ViewGroup#detachViewFromParent(View)
	 * ViewGroup.detachViewFromParent}. It will either be followed by
	 * {@link #onFinishTemporaryDetach()} or {@link #onDetachedFromWindow()}
	 ...
	 * check dynamic switch to make sure we only dump view when
	 * ViewDebug.SYSTEM_PROPERTY_CAPTURE_VIEW) is set
	 */
	private static void captureViewInfo(String subTag, View v) {
		if (v == null
				|| SystemProperties.getInt(
						ViewDebug.SYSTEM_PROPERTY_CAPTURE_VIEW, 0) == 0) {
			return;
		}
	 ...
	 * KeyEvent.DispatcherState} for this view's window. Returns null if the
	 * view is not currently attached to the window. Normally you will not need
	 * to use this directly, but just use the standard high-level event
	 * callbacks like {@link #onKeyDown}.
	 */
	 ...
	 * associated with the view hierarchy. This can be used to intercept key
	 * events in special situations before the IME consumes them; a typical
	 * example would be handling the BACK key to update the application's UI
	 * instead of allowing the IME to see it and close itself.
	 * 
	 * @param event
	...
	/**
	 * Dispatch a view visibility change down the view hierarchy. ViewGroups
	 * should override to route to their children.
	 * 
	 * @param changedView
	 *            The view whose visibility changed. Could be 'this' or an
	 *            ancestor view.
	 * @param visibility
	 *            The new visibility of changedView: {@link #VISIBLE},
	 ...
	 * a View moves out of the screen, it might receives a display hint
	 * indicating the view is not displayed. Applications should not
	 * <em>rely</em> on this hint as there is no guarantee that they will
	 * receive one.
	 * 
	 * @param hint
	...
	/**
	 * Gives this view a hint about whether is displayed or not. For instance,
	 * when a View moves out of the screen, it might receives a display hint
	 * indicating the view is not displayed. Applications should not
	 * <em>rely</em> on this hint as there is no guarantee that they will
	 * receive one.
	 * 
	...
	/**
	 * Dispatch a window visibility change down the view hierarchy. ViewGroups
	 * should override to route to their children.
	 * 
	 * @param visibility
	 ...
	 * {@link #GONE}, {@link #INVISIBLE}, and {@link #VISIBLE}). Note that this
	 * tells you whether or not your window is being made visible to the window
	 * manager; this does <em>not</em> tell you whether or not your window is
	 ...
	 * is attached to has been positioned in. This takes into account screen
	 * decorations above the window, for both cases where the window itself is
	 * being position inside of them or the window is being placed under then
	 * and covered insets are used for the window to position its content
	 * inside. In effect, this tells you the available area where content can be
	 * placed and remain visible to users.
	 * 
	 * <p>
	 * This function requires an IPC back to the window manager to retrieve the
	 * requested information, so should not be used in performance critical code
	 * like drawing.
	 * 
	 * @param outRect
	 ...
	 * view hierarchy. ViewGroups should override to route to their children.
	 * 
	 * @param newConfig
	...
	/**
	 * Returns whether the device is currently in touch mode. Touch mode is
	 * entered once the user begins interacting with the device by touch, and
	 ...
	 * with the view hierarchy. This can be used to intercept key events in
	 * special situations before the IME consumes them; a typical example would
	 * be handling the BACK key to update the application's UI instead of
	 * allowing the IME to see it and close itself.
	 * 
	 * @param keyCode
	 ...
	 * KeyEvent.Callback.onKeyMultiple()}: perform press of the view when
	 * {@link KeyEvent#KEYCODE_DPAD_CENTER} or {@link KeyEvent#KEYCODE_ENTER} is
	 ...
	 * Default implementation of
	 * {@link KeyEvent.Callback#onKeyMultiple(int, int, KeyEvent)
	 * KeyEvent.Callback.onKeyMultiple()}: perform clicking of the view when
	 * {@link KeyEvent#KEYCODE_DPAD_CENTER} or {@link KeyEvent#KEYCODE_ENTER} is
	 * released.
	 * 
	 * @param keyCode
	 ...
	 * {@link #onCreateInputConnection(EditorInfo)} to return true if a call on
	 * that method would return a non-null InputConnection, and they are really
	 * a first-class editor that the user would normally start typing on when
	 * the go into a window containing your view.
	 * 
	 * <p>
	 * The default implementation always returns false. This does <em>not</em>
	 * mean that its {@link #onCreateInputConnection(EditorInfo)} will not be
	 * called or the user can not otherwise perform edits on your view; it is
	 * just a hint to the system that this is not the primary purpose of this
	 * view.
	 * 
	 ...
	 * {@link #onCheckIsTextEditor()} to indicate you will return a non-null
	 * InputConnection.
	 * 
	 * @param outAttrs
	...
	/**
	 * Called by the {@link android.view.inputmethod.InputMethodManager} when a
	 * view who is not the current input connection target is trying to make a
	 * call on the manager. The default implementation returns false; you can
	 * override this to return true for certain views if you are performing
	 * InputConnection proxying to them.
	 * 
	 * @param view
	...
	public void createContextMenu(ContextMenu menu) {
		...
		if (mOnCreateContextMenuListener != null) {
			mOnCreateContextMenuListener.onCreateContextMenu(menu, this,
					menuInfo);
		}

		// Clear the extra information so subsequent items that aren't mine
		// don't
		// have my extra info.
	 ...
	 * <em>relative</em> movement of the trackball since the last event can be
	 * retrieve with {@link MotionEvent#getX MotionEvent.getX()} and
	 * {@link MotionEvent#getY MotionEvent.getY()}. These are normalized so that
	 ...
	 * context menu to come up if the user presses and holds at the same place,
	 * but you don't want it to come up if they press and then move around
	 * enough to cause scrolling.
	 */
	public void cancelLongPress() {
		 ...
		 * construct, but the tap callback will post a long press callback less
		 * its own timeout. Remove it here.
		 */
		removeTapCallback();
	}
	 ...
	 * 
	 * @param flags
	 *            Constant indicating the value which should be set
	 * @param mask
	 *            Constant indicating the bit range that should be changed
	 */
	 ...
	 * rectangle with the values from getScrollX(), getScrollY(), getWidth(),
	 * and getHeight().
	 * 
	 * @param outRect
	 ...
	 * 
	 * By default, the rectange is the {@link #getDrawingRect})of the view.
	 * However, if your view maintains some idea of internal selection, such as
	 * a cursor, or a selected row or column, you should override this method
	 * and fill in a more specific rectangle.
	 * 
	 * @param r
	 ...
	 * 
	 * @param offset
	 *            the numer of pixels to offset the view by
	 */
	 ...
	 * 
	 * <p>
	 * This method is automatically invoked by {@link #scrollBy(int, int)} and
	...
	/**
	 * Trigger the scrollbars to draw. This method differs from
	 * awakenScrollBars() only in its default duration.
	 * initialAwakenScrollBars() will show the scroll bars for longer than usual
	 * to give the user more of a chance to notice them.
	 * 
	 * @return true if the animation is played, false otherwise.
	 */
	 ...
	 * 
	 * @param startDelay
	 *            the delay, in milliseconds, after which the animation should
	 *            start; when the delay is 0, the animation starts immediately
	 * @return true if the animation is played, false otherwise
	 * 
	 * @see #scrollBy(int, int)
	 * @see #scrollTo(int, int)
	 ...
	 * {@link #isVerticalScrollBarEnabled()}. When the animation is started,
	 * this method returns true, and false otherwise. If the animation is
	 * started, this method calls {@link #invalidate()} if the invalidate
	...
	protected boolean awakenScrollBars(int startDelay, boolean invalidate) {
		...
		if (isHorizontalScrollBarEnabled() || isVerticalScrollBarEnabled()) {
			...
			long fadeStartTime = AnimationUtils.currentAnimationTimeMillis()
					+ startDelay;
	 ...
	 * visible, {@link #onDraw} will be called at some point in the future. This
	 ...
	 * thread. To call from a non-UI thread, call {@link #postInvalidate()}.
	 */
	...
	/**
	 * Indicates whether this View is opaque. An opaque View guarantees that it
	 * will draw all the pixels overlapping its bounds using a fully opaque
	 * color.
	 * 
	 * Subclasses of View should override this method whenever possible to
	 * indicate whether an instance is opaque. Opaque Views are treated in a
	 * special way by the View hierarchy, possibly allowing it to perform
	 * optimizations during invalidate/draw passes.
	 * 
	...
	private void computeOpaqueFlags() {
		...
		if (mBGDrawable != null
				&& mBGDrawable.getOpacity() == PixelFormat.OPAQUE) {
	 ...
	 * loop. Use this to invalidate the View from a non-UI thread.
	 * 
	 * @see #invalidate()
	 */
	...
	public void postInvalidateDelayed(long delayMilliseconds, int left,
		...
		// if we are not attached to our window
		if (mAttachInfo != null) {
			final AttachInfo.InvalidateInfo info = AttachInfo.InvalidateInfo
					.acquire();
			info.target = this;
			info.left = left;
			info.top = top;
	...
	/**
	 * Returns the strength, or intensity, of the top faded edge. The strength
	 * is a value between 0.0 (no fade) and 1.0 (full fade). The default
	 * implementation returns 0.0 or 1.0 but no value in between.
	 * 
	...
	/**
	 * Returns the strength, or intensity, of the bottom faded edge. The
	...
	/**
	 * Returns the strength, or intensity, of the left faded edge. The strength
	 * is a value between 0.0 (no fade) and 1.0 (full fade). The default
	 * implementation returns 0.0 or 1.0 but no value in between.
	 * 
	 * Subclasses should override this method to provide a smoother fade
	...
	/**
	 * Returns the strength, or intensity, of the right faded edge. The strength
	 * is a value between 0.0 (no fade) and 1.0 (full fade). The default
	 * implementation returns 0.0 or 1.0 but no value in between.
	 * 
	 * Subclasses should override this method to provide a smoother fade
	...
	protected final void onDrawScrollBars(Canvas canvas) {
		...
		if (cache != null) {
			...
			if (drawVerticalScrollBar || drawHorizontalScrollBar) {
				...
				final int scrollX = mScrollX;
				final int scrollY = mScrollY;
				final int inside = (viewFlags & SCROLLBARS_OUTSIDE_MASK) == 0 ? ~0
						: 0;
				...
				if (drawHorizontalScrollBar) {
					...
					top = scrollY + height - size
							- (mUserPaddingBottom & inside);
					left = scrollX + (mPaddingLeft & inside);
					right = scrollX + width - (mUserPaddingRight & inside)
							- verticalScrollBarGap;
					bottom = top + size;
					onDrawHorizontalScrollBar(canvas, scrollBar, left, top,
							right, bottom);
					if (invalidate) {
				...
				if (drawVerticalScrollBar) {
					...
					// TODO: Deal with RTL languages to position scrollbar on
					// left
					left = scrollX + width - size
							- (mUserPaddingRight & inside);
					top = scrollY + (mPaddingTop & inside);
					right = left + size;
					bottom = scrollY + height - (mUserPaddingBottom & inside);
					onDrawVerticalScrollBar(canvas, scrollBar, left, top,
							right, bottom);
					if (invalidate) {
						invalidate(left, top, right, bottom);
					}
	...
	/**
	 * Override this if the vertical scrollbar needs to be hidden in a subclass,
	 * like when FastScroller is visible.
	 * 
	...
	/*
	 * Caller is responsible for calling requestLayout if necessary. (This
	 * allows addViewInLayout to not request a new layout.)
	 */
	 ...
	 * window (attached to another containing window), then the token of the
	...
	/**
	 * @param info
	 *            the {@link android.view.View.AttachInfo} to associated with
	 *            this view
	 */
	...
	/**
	 * Called by {@link #saveHierarchyState} to store the state for this view
	 * and its children. May be overridden to modify how freezing happens to a
	 * view's children; for example, some views may want to not store state for
	 * their children.
	 * 
	 * @param container
	 *            The SparseArray in which to save the view's state.
	 ...
	 * current position on screen because that will be computed again when a new
	 * instance of the view is placed in its view hierarchy.
	 * <p>
	...
	/**
	 * Called by {@link #restoreHierarchyState} to retrieve the state for this
	 * view and its children. May be overridden to modify how restoreing happens
	 * to a view's children; for example, some views may want to not store state
	 * for their children.
	 * 
	 * @param container
		...
		if (state != BaseSavedState.EMPTY_STATE && state != null) {
			throw new IllegalArgumentException(
					"Wrong state class, expecting View State but "
							...
							+ " instead. This usually happens "
							+ "when two views of different type have the same id in the same hierarchy. "
							+ "This view's id is "
							+ ViewDebug.resolveId(mContext, getId())
							+ ". Make sure "
	 ...
	 * parent rather than from its own internal properties.
	 * </p>
	 * 
	 * <p>
	 * Note: in the current implementation, setting this property to true after
	 * the view was added to a ViewGroup might have no effect at all. This
	 * property should always be used from XML or set to true before adding this
	 * view to a ViewGroup.
	 * </p>
	 * 
	 * <p>
	 * Note: if this view's parent addStateFromChildren property is enabled and
	 * this property is enabled, an exception will be thrown.
	 * </p>
	 * 
	 * @param enabled
	 ...
	 * the next call to {@link #getDrawingCache()} or
	 * {@link #buildDrawingCache()} will draw the view in a bitmap. Calling
	 * {@link #draw(android.graphics.Canvas)} will not draw from the cache when
	 * the cache is enabled. To benefit from the cache, you must request the
	 * drawing cache by calling {@link #getDrawingCache()} and draw it on screen
	 ...
	 * <code>getDrawingCache(false)</code>.
	 * </p>
	 * 
	 ...
	 * bitmap is null when caching is disabled. If caching is enabled and the
	 * cache is not ready, this method will create it. Calling
	 * {@link #draw(android.graphics.Canvas)} will not draw from the cache when
	 * the cache is enabled. To benefit from the cache, you must request the
	 * drawing cache by calling this method and draw it on screen if the
	 ...
	 * Because this bitmap will be drawn scaled by the parent ViewGroup, the
	 * result on screen might show scaling artifacts. To avoid such artifacts,
	 * you should call this method by setting the auto scaling to true. Doing
	 * so, however, will generate a bitmap of a different size than the view.
	 * This implies that your application must be able to handle this size.
	 * </p>
	 * 
	 * @param autoScale
	 ...
	 * {@link #setDrawingCacheEnabled(boolean) setDrawingCacheEnabled(true)},
	 ...
	 * improve perfromance and memory usage. Note, though that this should only
	 * be used if this view will always be drawn on top of a solid color.
	 * 
	 * @param color
	 ...
	 * <p>
	 * Calling this method is equivalent to calling
	 * <code>buildDrawingCache(false)</code>.
	 * </p>
	 * 
	 * @see #buildDrawingCache(boolean)
	 */
	 ...
	 * {@link #setDrawingCacheEnabled(boolean) setDrawingCacheEnabled(true)},
	 * you should cleanup the cache by calling {@link #destroyDrawingCache()}
	 * afterwards.
	 * </p>
	 * 
	 * <p>
	...
	public void buildDrawingCache(boolean autoScale) {
		if ((mPrivateFlags & DRAWING_CACHE_VALID) == 0
				|| (autoScale ? (mDrawingCache == null || mDrawingCache.get() == null)
						: (mUnscaledDrawingCache == null || mUnscaledDrawingCache
								.get() == null))) {
			...
			final boolean scalingRequired = attachInfo != null
					&& attachInfo.mScalingRequired;
			...
			final boolean opaque = drawingCacheBackgroundColor != 0
					|| isOpaque();
			final boolean translucentWindow = attachInfo != null
					&& attachInfo.mTranslucentWindow;

			if (width <= 0
					|| height <= 0
					||
					// Projected bitmap size in bytes
					(width * height * (opaque && !translucentWindow ? 2 : 4) > ViewConfiguration
			...
			boolean clear = true;
			Bitmap bitmap = autoScale ? (mDrawingCache == null ? null
					: mDrawingCache.get())
					: (mUnscaledDrawingCache == null ? null
							: mUnscaledDrawingCache.get());
			...
			if (bitmap == null || bitmap.getWidth() != width
				...
				if (!opaque) {
					...
					// If the window is translucent, use a 32 bits bitmap to
					// benefit from memcpy()
					quality = translucentWindow ? Bitmap.Config.ARGB_8888
				...
				try {
					...
					// If there is not enough memory to create the bitmap cache,
					// just
					// ignore the issue as bitmap caches are not required to
					// draw the
					// view hierarchy
					if (autoScale) {
						mDrawingCache = null;
			...
			if (attachInfo != null) {
				...
				// Temporarily clobber the cached Canvas in case one of our
				// children
				// is also using a drawing cache. Without this, the children
				// would
				// steal the canvas by attaching their own bitmap to it and bad,
				// bad
				// thing would happen (invisible views, corrupted drawings,
				// etc.)
	...
	/**
	 * Create a snapshot of the view into a bitmap. We should probably make some
	...
	Bitmap createSnapshot(Bitmap.Config quality, int backgroundColor,
		...
		final AttachInfo attachInfo = mAttachInfo;
		final float scale = attachInfo != null ? attachInfo.mApplicationScale
				: 1.0f;
	...
	/**
	 * If the View draws content inside its padding and enables fading edges, it
	 * needs to support padding offsets. Padding offsets are added to the fading
	 * edges to extend the length of the fade so that it covers pixels drawn
	 * inside the padding.
	 * 
	...
	public void draw(Canvas canvas) {
		 ...
		 * 
		 * 1. Draw the background 2. If necessary, save the canvas' layers to
		 * prepare for fading 3. Draw view's content 4. Draw children 5. If
		 * necessary, draw the fading edges and restore layers 6. Draw
		 * decorations (scrollbars for instance)
		 */
		...
		if (verticalEdges) {
			topFadeStrength = Math.max(0.0f,
					Math.min(1.0f, getTopFadingEdgeStrength()));
			drawTop = topFadeStrength >= 0.0f;
			bottomFadeStrength = Math.max(0.0f,
					Math.min(1.0f, getBottomFadingEdgeStrength()));
			drawBottom = bottomFadeStrength >= 0.0f;
		}

		if (horizontalEdges) {
			leftFadeStrength = Math.max(0.0f,
					Math.min(1.0f, getLeftFadingEdgeStrength()));
			drawLeft = leftFadeStrength >= 0.0f;
			rightFadeStrength = Math.max(0.0f,
					Math.min(1.0f, getRightFadingEdgeStrength()));
	 ...
	 * color background, and needs to draw fading edges. Returning a non-zero
	 * color enables the view system to optimize the drawing of the fading
	 * edges. If you do return a non-zero color, the alpha should be set to
	 * 0xFF.
	 * 
	 ...
	 * 
	 * @param privateFlags
	 *            the private view flags to convert to a string
	 * @return a String representing the supplied flags
	 */
	 ...
	 * children to position them. This is typically done using the child
	 * measurements that were stored in the measure pass().
	 * 
	 * Derived classes with children should override onLayout. In that method,
	 * they should call layout on each of their their children.
	 * 
	 * @param l
	 ...
	 * on each of their their children.
	 * 
	 * @param changed
	...
	public void invalidateDrawable(Drawable drawable) {
		if (verifyDrawable(drawable)) {
			...
			invalidate(dirty.left + scrollX, dirty.top + scrollY, dirty.right
					+ scrollX, dirty.bottom + scrollY);
		}
	}
	 ...
	 * used when selecting a new Drawable into a view, so that the previous one
	 * is completely unscheduled.
	 * 
	 * @param who
	 ...
	 *            super class.
	 * 
	 * @return boolean If true than the Drawable is being displayed in the view;
	...
	/**
	 * This function is called whenever the state of the view changes in such a
	 ...
	 * this view. This is called by the view system when the cached Drawable
	 * state is determined to be invalid. To retrieve the current state, you
	 * should use {@link #getDrawableState}.
	 * 
	 * @param extraSpace
	...
	protected int[] onCreateDrawableState(int extraSpace) {
		...
		if (false) {
			...
			Log.i("View",
					toString() + " pressed=" + ((privateFlags & PRESSED) != 0)
							+ " en=" + ((mViewFlags & ENABLED_MASK) == ENABLED)
							+ " fo=" + hasFocus() + " sl="
							+ ((privateFlags & SELECTED) != 0) + " wf="
							+ hasWindowFocus + ": "
	 ...
	 *            {@link #onCreateDrawableState}, which will be modified to also
	 *            hold your own additional state values.
	 * 
	 * @param additionalState
	 *            The additional state values you would like added to
	 *            <var>baseState</var>; this array is not modified.
	 * 
	...
	public void setBackgroundDrawable(Drawable d) {
		...
		if (d != null) {
			...
			if (d.getPadding(padding)) {
				setPadding(padding.left, padding.top, padding.right,
						padding.bottom);
			}

			// Compare the minimum sizes of the old Drawable and the new. If
			// there isn't an old or
			...
			if ((mPrivateFlags & ONLY_DRAWS_BACKGROUND) != 0) {
				 ...
				 * the background, so now it won't draw anything (hence we
				 * SKIP_DRAW)
				 */
				mPrivateFlags &= ~ONLY_DRAWS_BACKGROUND;
				mPrivateFlags |= SKIP_DRAW;
	 ...
	 * the values returned from {@link #getPaddingLeft}, {@link #getPaddingTop},
	...
	public void setPadding(int left, int top, int right, int bottom) {
		...
		if ((viewFlags & (SCROLLBARS_VERTICAL | SCROLLBARS_HORIZONTAL)) != 0) {
			// TODO: Deal with RTL languages to adjust left padding instead of
			// right.
			if ((viewFlags & SCROLLBARS_VERTICAL) != 0) {
				right += (viewFlags & SCROLLBARS_INSET_MASK) == 0 ? 0
						: getVerticalScrollbarWidth();
			}
			if ((viewFlags & SCROLLBARS_HORIZONTAL) == 0) {
				bottom += (viewFlags & SCROLLBARS_INSET_MASK) == 0 ? 0
	 ...
	 * layout, happen.
	 * 
	 * The returned ViewTreeObserver observer is not guaranteed to remain valid
	 * for the lifetime of this View. If the caller of this method keeps a
	 * long-lived reference to ViewTreeObserver, it should always check for the
	 * return value of {@link ViewTreeObserver#isAlive()}.
	 * 
	...
	/**
	 * <p>
	 * Computes the coordinates of this view on the screen. The argument must be
	 * an array of two integers. After the method returns, the array contains
	 * the x and y location in that order.
	 * </p>
	 * 
	 * @param location
	...
	/**
	 * <p>
	 * Computes the coordinates of this view in its window. The argument must be
	 * an array of two integers. After the method returns, the array contains
	 * the x and y location in that order.
	 * </p>
	 * 
	 ...
	 * 
	 * @return a positive integer used to identify the view or {@link #NO_ID} if
	 *         the view has no ID
	 * 
	 * @see #setId
	 * @see #findViewById
	...
	/**
	 * Sets a tag associated with this view and a key. A tag can be used to mark
	...
	/**
	 * @param consistency
	 *            The type of consistency. See ViewDebug for more information.
	 * 
	 * @hide
	 */
	...
	/**
	 * Method that subclasses should implement to check their consistency. The
	 * type of consistency check is indicated by the bit field passed as a
	 * parameter.
	 * 
	 * @param consistency
	 *            The type of consistency. See ViewDebug for more information.
	 ...
	 *             if the view is in an inconsistent state.
	 * 
	 * @hide
	 */
	protected boolean onConsistencyCheck(int consistency) {
		...
		if (checkLayout) {
			if (getParent() == null) {
				result = false;
				android.util.Log.d(ViewDebug.CONSISTENCY_LOG_TAG, "View "
						+ this + " does not have a parent.");
			}

			if (mAttachInfo == null) {
				result = false;
				android.util.Log.d(ViewDebug.CONSISTENCY_LOG_TAG, "View "
						+ this + " is not attached to a window.");
			}
		}

		if (checkDrawing) {
			// Do not check the DIRTY/DRAWN flags because views can call
			// invalidate()
			...
			if ((mPrivateFlags & DRAWN) != DRAWN
				...
				android.util.Log.d(ViewDebug.CONSISTENCY_LOG_TAG, "View "
						+ this
						+ " was invalidated but its drawing cache is valid.");
			}
		}
	...
	protected void debug(int depth) {
		...
		output = debugIndent(depth);
		output += "mMeasureWidth=" + mMeasuredWidth + " mMeasureHeight="
				+ mMeasuredHeight;
		Log.d(VIEW_LOG_TAG, output);
	 ...
	 * boundary. If this widget does not support baseline alignment, this method
	 * returns -1.
	 * </p>
	 * 
	 ...
	 * this view. This will schedule a layout pass of the view tree.
	 */
	...
	/**
	 * Forces this view to be laid out during the next layout pass. This method
	 * does not call requestLayout() or forceLayout() on the parent.
	 */
	 ...
	 * 
	 * <p>
	 * <strong>CONTRACT:</strong> When overriding this method, you <em>must</em>
	 * call {@link #setMeasuredDimension(int, int)} to store the measured width
	 * and height of this view. Failure to do so will trigger an
	 * <code>IllegalStateException</code>, thrown by {@link #measure(int, int)}.
	 * Calling the superclass' {@link #onMeasure(int, int)} is a valid use.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * @param widthMeasureSpec
	 *            horizontal space requirements as imposed by the parent. The
	 *            requirements are encoded with
	 *            {@link android.view.View.MeasureSpec}.
	 * @param heightMeasureSpec
	 *            vertical space requirements as imposed by the parent. The
	 *            requirements are encoded with
	 *            {@link android.view.View.MeasureSpec}.
	 * 
	...
	/**
	 * Sets the minimum width of the view. It is not guaranteed the view will be
	 * able to achieve this minimum width (for example, if its parent layout
	...
	/**
	 * Sets the next animation to play for this view. If you want the animation
	 * to play immediately, use startAnimation. This method provides allows
	 * fine-grained control over the start time and invalidation, but you must
	 * make sure that 1) the animation has a start time set, and 2) the view
	 * will be invalidated when the animation is supposed to start.
	 * 
	 * @param animation
	 ...
	 * currently associated with this view. If you override this method, always
	 * call super.onAnimationStart();
	 * 
	 ...
	 * 
	 * @param region
	 *            The transparent region for this ViewRoot (window).
	 * 
	...
	public boolean gatherTransparentRegion(Region region) {
		...
		if (region != null && attachInfo != null) {
			...
			if ((pflags & SKIP_DRAW) == 0) {
				...
				getLocationInWindow(location);
				region.op(location[0], location[1], location[0] + mRight
						- mLeft, location[1] + mBottom - mTop,
						Region.Op.DIFFERENCE);
			} else if ((pflags & ONLY_DRAWS_BACKGROUND) != 0
					&& mBGDrawable != null) {
				// The ONLY_DRAWS_BACKGROUND flag IS set and the background
				// drawable
				// exists, so we remove the background drawable's
				// non-transparent
	 ...
	 * clicking, but you may wish to play these effects in your widget, for
	 * instance, for internal navigation.
	 * 
	 * <p>
	 * The sound effect will only be played if sound effects are enabled by the
	 * user, and {@link #isSoundEffectsEnabled()} is true.
	 * 
	 * @param soundConstant
	 *            One of the constants defined in {@link SoundEffectConstants}
	 */
	 ...
	 * such as long presses, but you may wish to provide feedback for your own
	 * widget.
	 * 
	 * <p>
	 ...
	 *            {@link HapticFeedbackConstants}
	 * @param flags
	 *            Additional flags as per {@link HapticFeedbackConstants}.
	 */
	public boolean performHapticFeedback(int feedbackConstant, int flags) {
		...
		return mAttachInfo.mRootCallbacks
	...
	/**
	 * This needs to be a better API (NOT ON VIEW) before it is exposed. If it
	 * is ever exposed at all.
	 * 
	 * @hide
	 */
	 ...
	 * that any non-transparent parts of the Drawable are removed from the given
	 * transparent region.
	 * 
	 * @param dr
	 *            The Drawable whose transparency is to be applied to the
	 *            region.
	 * @param region
	 *            A Region holding the current transparency information, where
	 *            any parts of the region that are set are considered to be
	 *            transparent. On return, this region will be modified to have
	 *            the transparency information reduced by the corresponding
	 *            parts of the Drawable that are not transparent. {@hide}
	 */
	public void applyDrawableToTransparentRegion(Drawable dr, Region region) {
		...
		if (r != null && attachInfo != null) {
			...
			if (db.bottom < h) {
				// Log.i("VIEW", "Drawable bottom " + db.bottom + " < view " +
				// h);
	...
	static class AttachInfo {
		...
		/**
		 * InvalidateInfo is used to post invalidate(int, int, int, int)
		 * messages to a Handler. This class contains the target (View) to
		 * invalidate and the coordinates of the dirty rectangle.
		 * 
		...
		/**
		 * For windows that are full-screen but using insets to layout inside of
		 * the screen decorations, these are the current insets for the content
		 * of the window.
		 */
		...
		/**
		 * For windows that are full-screen but using insets to layout inside of
		 * the screen decorations, these are the current insets for the actual
		 * visible parts of the window.
		 */
		final Rect mVisibleInsets = new Rect();

		/**
		 * The internal insets given by this window. This value is supplied by
		 * the client (through
		 * {@link ViewTreeObserver.OnComputeInternalInsetsListener}) and will be
		 * given to the window manager when changed to be used in laying out
		 * windows behind it.
		 */
		 ...
		 * used to determine if the window can be resized or must be panned to
		 * adjust for a soft input area.
		 */
		...
		/**
		 * Indicates that ViewRoot should trigger a global layout change the
		 * next time it performs a traversal
		 */
		...
		/**
		 * Global to the view hierarchy used as a temporary for dealing with x/y
		 * points in the transparent region computations.
		 */
		final int[] mTransparentLocation = new int[2];

		/**
		 * Global to the view hierarchy used as a temporary for dealing with x/y
		 * points in the ViewGroup.invalidateChild implementation.
		 */
		...
		/**
		 * Identifier for messages requesting the view to be invalidated. Such
		 * messages should be sent to {@link #mHandler}.
		 */
		...
		/**
		 * Temporary for use in computing invalidate rectangles while calling up
		 * the hierarchy.
		 */
		 ...
		 */
		AttachInfo(IWindowSession session, IWindow window, Handler handler,
	...
	/**
	 * <p>
	 * ScrollabilityCache holds various fields used by a View when scrolling is
	...
	private static class ScrollabilityCache implements Runnable {
		...
		public ScrollabilityCache(ViewConfiguration configuration, View host) {
			...
			scrollBarDefaultDelayBeforeFade = ViewConfiguration

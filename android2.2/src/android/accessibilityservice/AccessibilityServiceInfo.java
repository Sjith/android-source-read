...
/**
 * <br>
 * 描述{@link AccessibilityService}的类,系统通过此类来通知{@link AccessibilityService}发生了
 * {@link android.view.accessibility.AccessibilityEvent}事件</br> This class
 * describes an {@link AccessibilityService}. The system notifies an
 * {@link AccessibilityService} for
 * {@link android.view.accessibility.AccessibilityEvent}s according to the
...
public class AccessibilityServiceInfo implements Parcelable {
	 ...
	 * Default service is invoked only if no package specific one exists. In
	 * case of more than one package specific service only the earlier
	 * registered is notified.
	 */
	public static final int DEFAULT = 0x0000001;

	/**
	 * The event types an {@link AccessibilityService} is interested in. <br>
	 * 事件类型
	 * 
	...
	/**
	 * The package names an {@link AccessibilityService} is interested in.
	 * Setting to null is equivalent to all packages.
	 * {@link AccessiblilityService}感兴趣的包名，如果为null，则表示所有包。
	 */
	 ...
	 * {@link AccessibilityService} is notified. <br>
	 * 超时时间
	 * <p>

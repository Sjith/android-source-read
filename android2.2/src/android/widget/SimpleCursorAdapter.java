...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
	 ...
	 *            对应于from的资源id数组，每一个id对应于相同所因为只得from列
	 */
	...
	/**
	 * 创建一个映射，将列名映射为列号。如果cursor为null，则数组被抛弃
	 * <br>
	...
	/**
	 * 将cursor转换为string的接口,通常被SImpleCursorAdapter类使用。 <br>

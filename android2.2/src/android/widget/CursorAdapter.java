...
/**
 * 用于将{@link android.database.Cursor Cursor} 绑定到{@link android.widget.ListView
 * ListView}。本Cursor必须包含"_id" 列， 否则将无法使用。<br>
...
public abstract class CursorAdapter extends BaseAdapter implements Filterable,
	...
	/**
	 * Constructor. The adapter will call requery() on the cursor whenever it
	 * changes so that the most recent data is always displayed.
	 * 
	 * @param c
	...
	/**
	 * 变更使用的cursor，如果已经存在一个curso则关闭该cursor。
